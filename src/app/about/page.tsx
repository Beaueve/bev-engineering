...
export default function Home() {
  ...
  return (
    <>
      <div className=" sm:flex sm:items-center sm:h-svh">
        <div
          className="        
				w-full pb-20
        flex flex-col
        ...
        >
          ...
          <div className="p-4 mt-4 sm:mt-0">
            <div className=" ">
              <h1 className="text-4xl font-bold mb-2">Beau Everaert</h1>
              <h1 className="text-2xl text-gray-800 dark:text-white font-light mb-4">
                Software Engineer
              </h1>
              <p className="text-lg">
                ...
                in their infancy. It uses a dictionary of over 200 Latin words,
