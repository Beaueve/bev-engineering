    ...
    >
      ...
      {darkMode && (
        <div>
          ...
          {/* <div className="fixed z-51 h-[100vh] w-[100vw] bg-linear-to-b from-black from-50% to-transparent pointer-events-none"></div> */}
        </div>
      )}

      <div
        ref={containerRef}
        className="relative z-20 h-screen overflow-y-scroll snap-y snap-mandatory transition-colors duration-300 text-black black  dark:text-white"
      >
